...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '348387d5-1a67-464c-ad7a-b8bf1eca1ea5' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2313017f-612a-47e2-b14c-302fca65227e');
      cy.get(`[data-cy="name"]`).should('have.value', '2313017f-612a-47e2-b14c-302fca65227e');
